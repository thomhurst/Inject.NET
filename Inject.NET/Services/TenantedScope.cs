...
internal class TenantedScope(IServiceScope defaultScope, ServiceFactories serviceFactories) : ServiceScope((ServiceProviderRoot) defaultScope.RootServiceProviderRoot, serviceFactories)
{
